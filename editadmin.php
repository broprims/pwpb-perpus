...
<style>
    body{
        background-image: url("img/vector7.jpg");
...
include "koneksi.php";
$sql=mysqli_query($koneksi, "select * from tabel_data_admin where id='$_GET[kode]' ");
    ...
    <div id="wadah">
        ...
        <div id="kanan">
            ...
            <form action=" " method="POST" id="input">
                ...
                <input id="level" type="hidden" name="level" value="admin">
            ...
            if (isset($_POST['proses'])) {
                mysqli_query($koneksi, "update tabel_data_admin set
                ...
                if(isset($_POST['proses'])) {
                    echo "<script>alert('Berhasil edit!'); window.location.href='pageadmin.php?halaman=admin';</script>";
                } else {
