...
$sql=mysqli_query($koneksi, "select * from tabel_data_siswa where nis='$_GET[kode]' ");
    ...
    <div id="wadah">
        ...
        <div id="kanan">
            ...
            <form action=" " method="POST" id="input">
                ...
                <input disabled type="text" name="nis" class="input input1" placeholder="username" required value="<?php echo $data['nis']; ?>" >
                ...
                <div class="akun">
                    ...
                    <select name="gender" class="input" id="selectgender" required <?php echo $data['gender']; ?>>
...
<!--                    <a href=" --><?php //header('location:pagepetugas.php?halaman=siswa_petugas'); ?><!-- ">-->
<!--                        -->
<!--                    </a>-->
                    <input type="submit" class="buttonbawah registerbtn" value="Update" name="proses"  >
            ...
            if (isset($_POST['proses'])) {
                mysqli_query($koneksi, "update tabel_data_siswa set
                ...
                if($_POST['proses']) {
                    echo "<script>alert('Berhasil edit!'); window.location.href='pagepetugas.php?halaman=siswa_petugas';</script>";
                } else {
