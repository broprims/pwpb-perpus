<section class="KANAN grid">
    ...
    <section class="buku" id="bukupage">
        ...
        <nav class="nav">
            ...
            <ul class="ul">
                <li class="li">
                    <a class="a" id="terlambat"  href="pagepetugas.php?halaman=pinjam_petugas" >Pinjam</a>
                    <a class="a" id=""  href="pagepetugas.php?halaman=terlambat_petugas" >Terlambat</a>
                </li>
            ...
            <div class="Card">
                ...
                <table class="Card__table Table">
                    ...
                    <tr >
                        ...
                        <td> <a class='action hapus' href='pengembalian_petugas.php?id=$tampil[id]'> Dikembalikan </a> </td>
