...
if (!isset($_SESSION['Login']) AND ($_SESSION['level'] ="petugas")) {
...
<header class="page-header" style="margin: 0; padding: 0;">
    <nav>
        ...
        <ul id="btndahsboard" class="dashboard">
            <li>
                <a href="pagepetugas.php?halaman=dashboard_petugas">
        ...
        <ul  class="admin-menu" >
            ...
            <li id="btnsiswa">
                <a href="pagepetugas.php?halaman=siswa_petugas">
                    <svg  x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" >
                        <path d="M256,0c-74.439,0-135,60.561-135,135s60.561,135,135,135s135-60.561,135-135S330.439,0,256,0z"/>
                        <path d="M423.966,358.195C387.006,320.667,338.009,300,286,300h-60c-52.008,0-101.006,20.667-137.966,58.195
                        C51.255,395.539,31,444.833,31,497c0,8.284,6.716,15,15,15h420c8.284,0,15-6.716,15-15
            ...
            <li  id="btnbook">
                <a href="pagepetugas.php?halaman=buku_petugas">
            ...
            <li id="btnsiswa">
                <a href="pagepetugas.php?halaman=pengembalian_petugas">
                    <svg enable-background="new 0 0 513.124 513.124"  viewBox="0 0 513.124 513.124" >
                        <path d="m503.685 29.49h-64.92c-5.213 0-9.439 4.326-9.439 9.663v27.841h83.799v-27.842c-.001-5.336-4.227-9.662-9.44-9.662z"/>
                        <path d="m385.852 75.652h-64.919c-5.213 0-9.439 4.326-9.439 9.663v48.474h83.798v-48.474c-.001-5.337-4.227-9.663-9.44-9.663z"/>
                        <path d="m429.325 101.832h83.799v338.833h-83.799z"/>
...
<section class="page-content">
    <section class="search-and-user">
        ...
        <a href="pagepetugas.php?halaman=profile_petugas">
            <div id="profilepetugas" class="admin-profile">
    ...
    <section class="grid KANAN">
        ...
        switch ($queries['halaman'])
        {
            case 'petugas_page':
                ...
                include 'petugas_page.php';
                break;

            case 'siswa_petugas':

                include 'siswa_petugas.php';
                break;

            case 'buku_petugas':

                include 'buku_petugas.php';
                break;


            case 'pengembalian_petugas':

                include 'tampil_kembali_page_petugas.php';
                break;

            case 'profile_petugas':

                include 'profile_petugas.php';
                break;

            case 'terlambat_petugas':

                include 'tb_pinjam_petugas_2.php';
                break;

            case 'pinjam_petugas':

                include 'tb_pinjam_petugas_1.php';
                break;
