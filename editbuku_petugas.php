    ...
    <div id="wadah">
        ...
        <div id="kanan">
            ...
            <form enctype="multipart/form-data" action=" " method="POST" id="input">
                ...
                <input type="file" accept="image/png, image/jpeg" name="img" class="input input3" placeholder="Img buku" required value="<?php echo $data['img']; ?>">
            ...
            <?php
                ...
                if(isset($_POST['proses'])){
                    ...
                    if($query){
                        echo "<script>alert('Berhasil Mengubah Data!'); window.location.href='pagepetugas.php?halaman=buku_petugas';</script>";
                    }
                }
