            ...
            <div class="Card">
                ...
                <table class="Card__table Table">
                    ...
                    if(mysqli_num_rows($ambildata)){
                        ...
                        <td>$tampil[gender]</td>
                        <td>$tampil[age]</td>
                        <td class='tdaction'> <a class='action edit' href='editpetugas.php?kode=$tampil[id]'>Edit</a> <span> | </span> <a class='action hapus' href='deletepetugas.php?kode=$tampil[id]'> Hapus </a> </td>
                        </tr>
