        ...
        <div id="kanan">
            ...
            <form action=" " method="POST" id="input">
                ...
                <div class="btn2" alt="buttonlah">
                    ...
                    <input type="submit" class="buttonbawah registerbtn" value="Update" name="proses" href="#" >
            ...
            if (isset($_POST['proses'])) {
                ...
                if(isset($_POST['proses'])) {
                    echo "<script>alert('Berhasil edit!'); window.location.href='pagesiswa.php?halaman=profile_siswa';</script>";
                } else {
