    ...
    <div id="wadah">
        ...
        <div id="kanan">
            ...
            <form action=" " method="POST" id="input">
                ...
                <input type="text" name="nis" class="input input1" placeholder="nis" required>
            ...
            if (isset($_POST['proses'])) {
                ...
                if($_POST['proses']) {
                    echo "<script>alert('Berhasil Register!'); window.location.href='pagepetugas.php?halaman=siswa_petugas';</script>";
                } else {
