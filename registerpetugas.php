...
<head>
    <title>Tugas2</title>
    <link rel="stylesheet" href="css/registerpetugas.css">
</head>
<body>
        ...
        <div id="kanan">
            ...
            <form action=" " method="POST" id="input">
                ...
                <div class="akun">
                    ...
                    <input type="text" name="email" class="input input4" placeholder="email" required>
                ...
                <input type="text" name="notelpon" class="input input6" placeholder="no telpon" required>
                <input type="text" name="alamat" class="input input7" placeholder="alamat" required>
                <input type="text" name="age" class="input input8" placeholder="umur" required>
                ...
                <div class="btn2" alt="buttonlah">
                    <input type="submit" value="Register" class="buttonbawah registerbtn" name="proses">
            ...
            if (isset($_POST['proses'])) {
                mysqli_query($koneksi, "insert into tabel_data_petugas set
                ...
                if($_POST['proses']) {
                    echo "<script>alert('Berhasil Register!'); window.location.href='pageadmin.php?halaman=petugas';</script>";
                } else {
