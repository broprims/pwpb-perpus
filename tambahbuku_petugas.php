    ...
    <div id="wadah">
        ...
        <div id="kanan">
            ...
            <form action=" " method="POST" id="input" enctype="multipart/form-data">
                ...
                <input type="file" accept="image/png, image/jpeg" name="img" class="input input3" >
            ...
            if(isset($_POST['proses'])){
                ...
                if($query) {
                    echo "<script>alert('Berhasil Menambah!'); window.location.href='pagepetugas.php?halaman=buku_petugas';</script>";
                } else {
