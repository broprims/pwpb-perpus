            ...
            <div class="p2">
                ...
                <div class="atas">
                    ...
                    <div class="textatas">
                        ...
                        $ambildata = mysqli_query($koneksi, "SELECT * FROM tabel_data_admin WHERE tabel_data_admin.username = '$_SESSION[username]'");
                        ...
                        while ($tampil = mysqli_fetch_array( $ambildata))
                        {
                            echo "
                                ...
                                <div class='aturaction'>
                                    <td><a class='actionprofile editprofile' href='editadmin.php?kode=$tampil[id]'>Edit</a></td>
                                </div>
