        ...
        <div class="container">
            <div class="Card">
                ...
                <table class="Card__table Table">
                    ...
                    $query = $_POST['query'];
                    if($query != ''){
                        $ambildata = mysqli_query($koneksi, "SELECT * FROM tabel_data_admin WHERE username LIKE '%$query%' OR fullname LIKE '%$query%'");
                    }else{
                        $ambildata = mysqli_query($koneksi, "select * from tabel_data_admin ");
                    }
                    if(mysqli_num_rows($ambildata)){
                        ...
                        echo "
                                    ...
                                    <tr >
                                          ...
                                          <td>$tampil[gender]</td>
                                          <td>$tampil[age]</td>
                                           <td> <a class='actionhide editadmin' href='#'>Edit</a> <span> | </span> <a class='actionhide hapusadmin' href='#'> Hapus </a> </td>
                                    </tr>
                ...
                <div class="Card__content">
                    <div class="Card__content-text">
                        ...
                        $jumlah_admin = mysqli_num_rows($ambildata);
                        ?>
                        <p> <b><?php echo $jumlah_admin;?></b> result </p>
